...
public class SwitchPairs {
    ...
    public static ArrayList<String> swapped2 (ArrayList<String> list) {
    ...
    public static ArrayList <String> swapped(ArrayList <String> list) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(swapped2(list));
